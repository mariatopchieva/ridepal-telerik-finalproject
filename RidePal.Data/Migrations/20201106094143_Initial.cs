        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistTracklistURL = table.Column<string>(nullable: true),
                    ArtistPictureURL = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenrePictureURL = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumTrackListURL = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackDuration = table.Column<int>(nullable: false),
                    AlbumId = table.Column<long>(nullable: true),
                    TrackRank = table.Column<long>(nullable: false),
                    TrackUrl = table.Column<string>(nullable: true),
                    TrackPreviewURL = table.Column<string>(nullable: true),
                    GenreId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
